...
ax_cs.plot(data[0:2200,3], data[0:2200, 14], 'brown')
ax_cs.set_ylim([0,np.pi])
ax_cs.set_xlabel(r'$\theta_1$')
ax_cs.set_ylabel(r'$\theta_2$')
fig_cs.savefig('wm_switching_ex1_2_cs.png', format='png', transparent=True, dpi=200)
...
ax_ws.plot(data[0:2200, 7], data[0:2200, 8], 'brown')
# fig.savefig('ex1_1.png', dpi=200, format='png', transparent=True)
draw_configuration(ax_ws, data[2200], 'black')
# draw_configuration(plt, data[7999], 'blue')
fig_ws.savefig('wm_switching_ex1_2_ws.png', format='png', transparent=True, dpi=200)
plt.show()